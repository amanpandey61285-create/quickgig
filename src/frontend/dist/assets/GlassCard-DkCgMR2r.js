import { c as createLucideIcon, j as jsxRuntimeExports, L as LoaderCircle, e as cn, r as reactExports } from "./index-Bhvb_wkP.js";
/**
...
const variantStyles = {
  primary: "gradient-primary text-white shadow-lg hover:opacity-90 hover:shadow-primary/25 active:scale-95",
  secondary: "bg-secondary text-secondary-foreground shadow-lg hover:bg-secondary/90 active:scale-95",
  accent: "gradient-accent text-foreground shadow-lg hover:opacity-90 hover:shadow-accent/25 active:scale-95",
  outline: "border-2 border-primary text-primary bg-transparent hover:bg-primary/10 active:scale-95",
...
function GlassCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      className: cn(
        hover2 ? "glass-card-hover" : "glass-card",
        paddingMap[padding],
        className
      ),
      ...props,
